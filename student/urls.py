...
from .views import (
    ...
    StudentDeleteView,
    StudentImportView,
    StudentImportErrorReportView,
    StudentImportTemplateView,
    SubjectListView,
    SubjectImportView,
    SubjectImportErrorReportView,
...
urlpatterns = [
    ...
    path('import/errors/', StudentImportErrorReportView.as_view(), name='student-import-errors'),
    ...
    path('subjects/import/errors/', SubjectImportErrorReportView.as_view(), name='subject-import-errors'),
